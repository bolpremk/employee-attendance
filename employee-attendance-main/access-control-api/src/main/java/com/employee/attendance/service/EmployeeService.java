...
public class EmployeeService {
    ...
    /**
     * Updates the employee event based on the employee's swipe action.
     *
     * @param employeeDto DTO containing information about the employee swipe action.
     * @return The updated EmployeeEvent object.
     */
    ...
    /**
     * Retrieves the list of employee events for a given employee ID.
     *
    ...
    /**
     * Calculates the total hours worked by employees and sends status updates via Kafka.
     */
